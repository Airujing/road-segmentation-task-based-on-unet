...
\pic[shift={(0,0,0)}] at (p3-east) {RightBandedBox={name=cr4,%
        xlabel={{"256","256"}},caption=I/8,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(0,0,0)}] at (p4-east) {RightBandedBox={name=cr5,caption=I/16,%
        xlabel={{"512","512"}},fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(0,0,0)}] at (cr5-east) {Box={name=up4,%
        fill=\UnpoolColor,opacity=0.6,height=1,width=1,depth=1}};
